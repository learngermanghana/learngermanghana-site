  ...
  return (
    <Container>
      <section className="py-12 sm:py-16">
        ...
        <div className="mt-6 rounded-[28px] bg-gradient-to-br from-brand-900 via-brand-800 to-emerald-900 p-6 sm:p-8 text-white shadow-sm ring-1 ring-black/10">
          <div className="text-sm text-white/80">How to enroll (No registration form)</div>
          <div className="mt-1 text-2xl font-semibold text-white">Register inside Falowen</div>
          ...
          <div className="mt-5 flex flex-col sm:flex-row gap-3">
            ...
            <a
              href="/register"
              className="inline-flex items-center justify-center rounded-2xl border border-white/50 bg-white/10 px-6 py-3 text-sm font-semibold text-white hover:bg-white/20"
            >
              Full instructions
            </a>
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center justify-center rounded-2xl border border-white/45 bg-black/20 px-6 py-3 text-sm font-semibold text-white hover:bg-black/30"
            >
              WhatsApp help
            </a>
          </div>
